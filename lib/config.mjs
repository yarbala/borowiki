...
export const HOME = { lat: 51.1079, lon: 17.0385, label: 'Вроцлав' };

/** Радиус покрытия данными, км. Ползунок в интерфейсе (20–100 км) работает внутри него. */
export const DATA_RADIUS_KM = 200;
