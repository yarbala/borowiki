...
4. Оставшиеся ячейки пересекаются с контурами лесов, склеиваются в связные области и режутся на куски
   ...
   На карту идёт сам контур леса под грозой, закрашенный по оценке: видно не круг поверх карты,
   а конкретный массив, который накрыло.
...
- **Закрашивается контур леса, а не круг вокруг пятна.** В макете пятно — круг, но на реальных
  данных круг закрывал сам лес, и было непонятно, о каком массиве речь. Теперь заливается
  настоящий контур из тайлов, а точка-маркер осталась, чтобы место было заметно на мелком масштабе.
